...
class Config(object):
    # Bot Information 
    TECH_VJ_BOT_TOKEN = os.environ.get("TECH_VJ_BOT_TOKEN", "6333123201:AAErfDwxzB4O7YC_peHO7kNmq85YRKAR-Pg")
    TECH_VJ_BOT_USERNAME = os.environ.get("TECH_VJ_BOT_USERNAME", "URL3700_bot") # Bot username without @.
    
    # The Telegram API things
    TECH_VJ_API_ID = int(os.environ.get("TECH_VJ_API_ID", "20346550"))
    TECH_VJ_API_HASH = os.environ.get("TECH_VJ_API_HASH", "bc79c3bea7a626887bdc0871eecf0327")
    ...
    TECH_VJ_OWNER_ID = int(os.environ.get("TECH_VJ_OWNER_ID", "5665231556")) 
    ...
    # channel information
    TECH_VJ_LOG_CHANNEL = int(os.environ.get("TECH_VJ_LOG_CHANNEL", "-1001956064627")) # your log channel id and make bot admin in log channel with full right 
